...
public class BarCommentAdapter extends RecyclerView.Adapter<BarCommentAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            mItemCommentUserHeadimg = itemView.findViewById(R.id.item_comment_user_headimg);
            mItemCommentUsername = itemView.findViewById(R.id.item_comment_username);
            mItemCommentDate = itemView.findViewById(R.id.item_comment_date);
            mItemCommentFloor = itemView.findViewById(R.id.item_comment_floor);
            mItemCommentTxt = itemView.findViewById(R.id.item_comment_txt);
            mItemCommentR = itemView.findViewById(R.id.item_comment_R);
        }
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (!DataVerificationTool.isEmpty(comment.getComment_touser())) {
