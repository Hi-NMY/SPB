...
public class SendNewVideo extends BaseMVPActivity<ISendNewVideoAView, SendNewVideoAPresenterImpl> implements ISendNewVideoAView {
    ...
    protected void initActView() {
        ...
        videoTool = new VideoTool(SendNewVideo.this, MyApplication.getContext(), mDetailPlayer);
        initData();
        setMyListener();
        setActivityBar();
        setBar();
            ...
            public void initListener() {
                ...
                mLocationErrorR.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        mPresenter.initLocationList(SendNewVideo.this, new LinearLayoutManager(MyApplication.getContext()), mLocationRecycler);
                    }
                });
                SearchFun.search(mLocationSearchEdt, new SearchFun.GoSearch() {
                    ...
                    public void afterTextChangedSearch(String text) {
                        if (text.equals("")) {
                            ...
                            mPresenter.searchLocation(text, SendNewVideo.this, new LinearLayoutManager(MyApplication.getContext()), mLocationRecycler);
                        }
                    }
                });
            }
