...
public class ScrollCalculatorHelper {
    ...
    void playVideo(RecyclerView view) {
        ...
        StandardGSYVideoPlayer gsyBaseVideoPlayer = null;

        boolean needPlay = false;

        for (int i = 0; i < visibleCount; i++) {
            if (layoutManager.getChildAt(i) != null && layoutManager.getChildAt(i).findViewById(playId) != null) {
                StandardGSYVideoPlayer player = (StandardGSYVideoPlayer) layoutManager.getChildAt(i).findViewById(playId);
                Rect rect = new Rect();
        ...
        if (gsyBaseVideoPlayer != null && needPlay) {
            ...
            if (runnable != null) {
                StandardGSYVideoPlayer tmpPlayer = runnable.gsyBaseVideoPlayer;
    ...
    private class PlayRunnable implements Runnable {
        ...
        StandardGSYVideoPlayer gsyBaseVideoPlayer;

        public PlayRunnable(StandardGSYVideoPlayer gsyBaseVideoPlayer) {
